        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <section className="bg-white p-6 border border-gray-100 rounded-[2rem] shadow-sm">
              ...
              {/* Tabs */}
              <div className="flex gap-2 mb-5 bg-gray-50 p-1.5 rounded-2xl">
                <button
                ...
                <div className="space-y-4">
                  <label className="block cursor-pointer">
                    <div
                      ...
                      onDrop={handleDrop}
                      className={`flex flex-col items-center justify-center w-full h-44 border-2 border-dashed rounded-2xl transition-all group ${
                        isAnalyzing
                    ...
                    >
                      ...
                      {isAnalyzing ? (
                        ...
                        <>
                          <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-3 shadow-sm transition-all ${isDragOver ? "bg-red-600 scale-110" : "bg-white group-hover:scale-110"}`}>
                            <Video className={`w-6 h-6 transition-colors ${isDragOver ? "text-white" : "text-gray-400 group-hover:text-red-600"}`} />
                          </div>
                ...
                <>
                  <div className="mt-5 pt-5 border-t border-gray-50">
                    <div className="flex items-center gap-3 text-gray-400">
                      <div className="bg-gray-50 p-2.5 rounded-xl text-red-600 flex-shrink-0">
          ...
          <div className="space-y-8">
            {resultadoAnalise ? (
              ...
              <div className="h-full min-h-0 border-2 border-dashed border-gray-100 rounded-[2rem] bg-white/30 flex flex-col items-center justify-center text-center p-10">
                <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-5 shadow-inner">
                  <CheckCircle className="w-8 h-8 text-gray-200" />
                </div>
                <h3 className="text-gray-400 font-black uppercase tracking-widest text-[10px]">
                  Aguardando Processamento
                </h3>
                <p className="text-gray-900 text-[10px] max-w-[250px] mt-3 font-bold uppercase tracking-widest leading-relaxed opacity-40">
