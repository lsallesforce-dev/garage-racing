...
function CentralChatInner() {
  ...
  const statusCfg = selectedLead?.status
    ...
    : null;
  const origemInfo = selectedLead ? origemCfg(selectedLead.origem) : null;
      ...
      <div className={`${showChat ? "hidden md:flex" : "flex"} w-full md:w-96 flex-shrink-0 bg-white border-r border-gray-100 flex-col`}>
        ...
        <div className="flex-1 overflow-y-auto">
          {leadsFiltrados.length === 0 ? (
            ...
            const origem = origemCfg(lead.origem);
                ...
                <div key={msg.id} className={`flex ${isAgente ? "justify-end" : "justify-start"}`}>
                  <div className={`max-w-[85%] sm:max-w-[70%] flex flex-col gap-1 ${isAgente ? "items-end" : "items-start"}`}>
                    ...
                    <div className="flex items-center gap-1.5 px-1">
                      <span className="text-[16px] text-gray-500 font-bold uppercase tracking-wider">
