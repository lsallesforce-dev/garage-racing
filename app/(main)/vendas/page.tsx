        ...
        body: JSON.stringify({
          ...
          dados: {
            ...
            veiculo: {
              ...
              cor: (veiculo as any).cor || "",
              combustivel: (veiculo as any).combustivel || "",
              cilindradas: (veiculo as any).cilindradas || null,
              potencia_cv: (veiculo as any).potencia_cv || null,
              motor: (veiculo as any).motor || "",
              quilometragem: (veiculo as any).quilometragem_estimada || null,
