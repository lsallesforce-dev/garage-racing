...
// Upload da logo EXCLUSIVA da vitrine pública (separada da logo geral da loja).
// Espelha app/api/vitrine/capa/route.ts, mas grava em vitrine-logos/{user_id}.{ext}.
// A URL resultante é salva em config_garage.vitrine_tema.logo_url pelo client.
export async function POST(req: NextRequest) {
  try {
    ...
    const path = `vitrine-logos/${user!.id}.${ext}`;
